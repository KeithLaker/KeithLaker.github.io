...
'af_train.TIP_STOP_ERROR':'{0} with Error in: {1}',
...
'af_train.TIP_STOP_INFORMATION':'{0} with Information in: {1}',
...
'af_train.UNVISITED_STEP':'Unvisited Step',
...
'af_query.TIP_OPERATOR':'Operators for {0}',
...
'AFUnsupportedBrowser':'You are using an unsupported browser. The supported browsers are Internet Explorer 7 and higher, Firefox 3.0 and higher, Safari 3.1.2 and higher, and Google Chrome 5.0 and higher.',
...
'af_train.TIP_STOP_CONFIRMATION':'{0} with Confirmation in: {1}',
...
'af_train.TIP_STOP_WARNING':'{0} with Warning in: {1}',
